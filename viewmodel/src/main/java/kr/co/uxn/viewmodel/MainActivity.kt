...
import kr.co.uxn.viewmodel.ui.theme.ComposePracticeTheme
...
class ToDoViewModel : ViewModel() {
    // 기존 remember의 생명주기와, 뷰모델의 생명주기가 다르기 때문에, remember는 지우자.
    // 따라서 remember를 붙인다는 의미는 composable의 생명주기에 맞추겐단 말이다.
